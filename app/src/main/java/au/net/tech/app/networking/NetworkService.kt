...
interface NetworkService {
    ...
    fun openTicket(
        ...
        @Field("contactid") contactid: String? ): Single<TicketSuccessDto>
    ...
    @GET("customers/search/company")
    fun getCompanies(
        @Header("authtoken") authToken : String = AppSharedPrefs.getUser()?.authtoken ?: ""): Single<ArrayList<Company>>
